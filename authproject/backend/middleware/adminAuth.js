...
module.exports = async (req, res, next) => {
  try {
    ...
    // Verify admin still exists and is active (database validation)
    if (decoded.id) {
      const admin = await Admin.findById(decoded.id).select('isActive isVerified email role permissions');
